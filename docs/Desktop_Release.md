...
```powershell
.\publish-installer-win-x64.ps1 -Version 0.1.0.7-preview.3
```
...
```text
artifacts/ETAB-Engineering-v0.1.0.7-preview.3-win-x64.zip
artifacts/ETAB-Engineering-v0.1.0.7-preview.3-win-x64.zip.sha256
artifacts/ETAB-Engineering-v0.1.0.7-preview.3-win-x64-setup.exe
artifacts/ETAB-Engineering-v0.1.0.7-preview.3-win-x64-setup.exe.sha256
```
...
For preview version `0.1.0.7-preview.3`, publish with:

```powershell
git tag -a v0.1.0.7-preview.3 -m "ETAB Engineering v0.1.0.7-preview.3"
git push origin v0.1.0.7-preview.3
```
